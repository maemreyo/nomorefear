...
! ==============================================================================================================
        =>> Approach 1: (Traverse the array, find the minimum sum of each pair in the array)
...
! ==============================================================================================================
        =>> Approach 2: (Sort the array, and use two pointers to calc the sum)
            -> Sort the array
            -> Initialize two pointers from the beginning and the end of the array
