"""
    ...
    |🙌🏻 APPROACHES
        ...
        @Approach 2:
            ...
            -> Make an array of “ele” structures of size n, where n is the size of the input array, and set the “val”
            field of each element to the value from the input array and the “count” field to 0.
            -> Traverse through the input array and for each element,  increase the count field of the corresponding
            “ele” structure by 1.
            -> Using the quicksort method and a custom comparison function for elements, sort the “ele” array in
            decreasing order of count and rising order of value.
            -> Finally, recreate the input array by iterating over the sorted “ele” array in descending order of count
            and adding the value of each element to the input array count number of times equal to its count field.
