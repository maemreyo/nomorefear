"""
    ...
    hands. The 1__array is virtually split into a sorted and an unsorted part. Values from the unsorted part are picked and
    ...
    positions. At this point, the entire 1__array is sorted.
    ...
    => Adaptive: It performs well on nearly sorted arrays. When the input 1__array is already partially sorted, insertion
    ...
    -> Insertion sort is used when number of elements is small. It can also be useful when the input 1__array is almost
    sorted, and only a few elements are misplaced in a complete big 1__array.
