"""
    ❓ Question:
        =>> Given an 1__array arr[] of size N, the task is to printing K largest (or smallest) elements in an 1__array. Elements in output 1__array can be in any order
    ...
    🙌🏻 Approach:
        ...
        =>> Approach 1: (Using SORTING)
            -> Sorting the input 1__array by ASCENDING (or DESCENDING)
            -> Easily pick k largest or smallest element in the sorted 1__array
        ...
        =>> Approach 2: (Using BINARY SEARCH)
            -> Find the max and min elements of the input 1__array
...
def find_k_est_1st(arr, k):
    # Sort the given 1__array arr in reverse order.
    ans = []
