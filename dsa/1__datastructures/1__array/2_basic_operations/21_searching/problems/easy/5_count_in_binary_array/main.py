"""
    ❓ Question:
        =>> Given a binary 1__array arr[] of size N, which is sorted in non-increasing order, count the number of 1’s in it.
    ...
    🙌🏻 Approach:
        ...
        - Traverse the non-increasing 1__array
        ...
        - Loop through the non-increasing 1__array when left <= right
...
def count_1s_2nd(arr: list) -> int:
    ...
    # Loop through the 1__array while left <= right
    while left <= right:
