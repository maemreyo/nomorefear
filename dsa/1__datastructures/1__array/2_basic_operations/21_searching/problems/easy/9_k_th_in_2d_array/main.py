"""
    ❓ Question:
        ...
        element in the given 2D 1__array.

    🗳️ Example:
        Input: k = 3 and 1__array =
                10, 20, 30, 40
                15, 25, 35, 45
                24, 29, 37, 48
                32, 33, 39, 50
    ...
    🙌🏻 Approach:
        ...
        =>> Approach 1:
            ...
            # * For each element in the 2D 1__array, it pushes the element onto the priority queue using heapq.heappush().
            # * This ensures that the smallest element encountered in the 1__array is inserted into the priority queue,
        ...
        =>> Approach 3:
            ...
            -> Copy all the elements of the matrix into that 1__array
            -> Sort that 1__array
